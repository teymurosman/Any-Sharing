...
//        final long userId = 1;
//
//        CommentFromRequest commentFromRequest = CommentFromRequest.builder()
...
//
//        when(commentMapper.toComment(commentFromRequest))
//                .thenReturn(comment);
...
//                .header(HEADER_USER_ID, userId)
//                .contentType(MediaType.APPLICATION_JSON)
//                .content(objectMapper.writeValueAsString(commentFromRequest)))
//                .andExpect(status().isOk())
